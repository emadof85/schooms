...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'Al-Mahabah school'],
            ['type' => 'system_name', 'description' => 'Al-Mahabah school For Special Education'],
            ['type' => 'term_ends', 'description' => '31/01/2026'],
            ['type' => 'term_begins', 'description' => '01/09/2025'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => '27Rd Street, New York, USA'],
            ['type' => 'system_email', 'description' => 'support@maitechno.com'],
