...
var DatatableButtonsHtml5 = function() {
    ...
    var _componentDatatableButtonsHtml5 = function() {
        ...
        // Column selectors
		var dt_html5_options = {
		    dom: '<"datatable-header"fBl><"datatable-scroll-wrap"t><"datatable-footer"ip>', // Add buttons to DOM
		    buttons: {
		        buttons: [
		            {
		                extend: 'copyHtml5',
		                className: 'btn btn-light',
		                text: (window.dtButtonTranslations && window.dtButtonTranslations.copy) || 'Copy' // Use translation
		            },
		            {
		                extend: 'excelHtml5',
		                className: 'btn btn-light',
		                text: (window.dtButtonTranslations && window.dtButtonTranslations.excel) || 'Excel' // Use translation
		            },
		            {
		                extend: 'pdfHtml5',
		                className: 'btn btn-light',
		                text: (window.dtButtonTranslations && window.dtButtonTranslations.pdf) || 'PDF' // Use translation
		            },
		            {
		                extend: 'colvis',
		                className: 'btn bg-blue btn-icon dropdown-toggle',
		                text: '<i class="icon-three-bars"></i> ' + ((window.dtButtonTranslations && window.dtButtonTranslations.visibility) || 'Visibility') // Use translation
		            }
		        ]
		    }
		};
