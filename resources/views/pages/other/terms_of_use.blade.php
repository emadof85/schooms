                    ...
                    <div class="card-body">
                        <div class="row">
                            <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.changes_to_the_terms_of_use') }}</h4>
                                ...
                                <h3>{{ __('msg.article_i') }}</h3>
                                <p>{{ __('msg.you_are_responsible_for') }}</p>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.intellectual_property_rights') }}</h4>
                               ...
                               <p>The Website and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are owned by us, our licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws.</p>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.trademarks') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.prohibited_uses') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.additionally_you_agree_not_to') }}</h4>
                                <ul>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.user_contributions') }}</h4>
                                ...
                                <p>{{ __('msg.you_represent_and_warrant_that') }}</p>
                                ...
                                <p>{{ __('msg.we_have_the_right_to') }}</p>
                               ...
                               <p> Without limiting the foregoing, we have the right to fully cooperate with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone posting any materials on or through the Website.</p>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.content_standards') }}</h4>
                                ...
                                <ul>
                                    ...
                                    <li>Violate the legal rights (including the rights of publicity and privacy) of others or contain any material that could give rise to any civil or criminal liability under applicable laws or regulations or that otherwise may be in conflict with these Terms of Use and our <a target="_blank" href="{{ route('privacy_policy') }}">{{ __('msg.privacy_policy_fa2e') }}</a>.</li>
                                    <li>{{ __('msg.be_likely_to_deceive_any_person') }}</li>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.copyright_infringement') }}</h4>
                                <p>If you believe that any User Contributions violate your copyright, please contact us</p>

                                <h5 class="font-weight-semibold">{{ __('msg.reliance_on_information_posted') }}</h5>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.changes_to_the_website') }}</h4>
                                ...
                                <p>All information we collect on this Website is subject to our Privacy Policy. By using the Website, you consent to all actions taken by us with respect to your information in compliance with the <a target="_blank" href="{{ route('privacy_policy') }}">{{ __('msg.privacy_policy_fa2e') }}</a>.</p>

                                <h3>{{ __('msg.article_ii') }}</h3>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.links_from_the_website') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.disclaimer_of_warranties') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.limitation_on_liability') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.indemnification') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.governing_law_and_jurisdiction') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.arbitration') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.limitation_on_time_to_file_claims') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.waiver_and_severability') }}</h4>
                                ...
                                <h4 class="font-weight-semibold">{{ __('msg.entire_agreement') }}</h4>

                                <p>These Terms of Use and our <a target="_blank" href="{{ route('privacy_policy') }}">{{ __('msg.privacy_policy_fa2e') }}</a> constitute the sole and entire agreement between you and {{ $app_name }} with respect to the Website and supersede all prior and contemporaneous understandings, agreements, representations and warranties, both written and oral, with respect to the Website.</p>

                                <h5 class="font-weight-semibold">{{ __('msg.your_comments_and_concerns') }}</h5>
