        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('support_team.communication.send_sms') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>{{ __('msg.message') }} (<span id="charCount">0</span>/160 {{ __('msg.characters') }})</label>
                        <textarea name="message" class="form-control" rows="3" maxlength="160" required onkeyup="updateCharCount()"></textarea>
