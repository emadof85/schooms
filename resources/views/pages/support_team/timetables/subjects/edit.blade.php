<div class="tab-pane fade" id="edit-subs">
    ...
    @if($tts->count())
                            ...
                            <div class="card-header header-elements-inline">
                                ...
                                <div class="header-elements">
                                    <div class="list-icons">
                                        <a onclick="confirmDelete(this.id)" href="#" id="{{ $tt->id }}" title="{{ __('msg.delete') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input autocomplete="off" name="exam_date"
                                                           ...
                                                           placeholder="{{ __('msg.select_date') }}">
                                                </div>
                                            </div>
        ...
        <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <select data-placeholder="{{ __('msg.select_time') }}" required class="select form-control" name="ts_id" id="ts_id">
