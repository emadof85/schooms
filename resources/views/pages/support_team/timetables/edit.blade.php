...
@section('page_title', __('msg.edit_timetable_record'))
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">{{ __('msg.edit_timetable_record') }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="col-md-8">
                <form class="ajax-update" method="post" action="{{ route('ttr.update', $ttr->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $ttr->name }}" required type="text" class="form-control" placeholder="{{ __('msg.name_of_timetable') }}">
                        </div>
                    </div>
