    ...
    <div class="card">
        ...
        <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-highlight">
                    <li class="nav-item"><a href="#all-uc" class="nav-link active" data-toggle="tab">{{ __('msg.incomplete_payments') }}</a></li>
                    <li class="nav-item"><a href="#all-cl" class="nav-link" data-toggle="tab">{{ __('msg.completed_payments') }}</a></li>
                </ul>
            ...
            <div class="tab-pane fade show active" id="all-uc">
                <table class="table datatable-button-html5-columns table-responsive">
                    ...
                    <tr>
                        ...
                        <th>{{ __('msg.pay_ref') }}</th>
                        <th>{{ __('msg.amount_b2f4') }}</th>
                        <th>{{ __('msg.paid') }}</th>
                        <th>{{ __('msg.balance') }}</th>
                        <th>{{ __('msg.pay_now') }}</th>
                        <th>{{ __('msg.receipt_no') }}</th>
                        <th>{{ __('msg.year') }}</th>
                        <th>{{ __('msg.action') }}</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($uncleared as $uc)
                        <tr>
                            ...
                            <td>
                             ...
                             <div class="row">
                                 <div class="col-md-7">
                                     <input min="1" max="{{ $uc->balance ?: $uc->payment->amount }}" id="val-{{ Qs::hash($uc->id) }}" class="form-control" required placeholder="{{ __('msg.pay_now') }}" title="{{ __('msg.pay_now') }}" name="amt_paid" type="number">
                                 </div>
                                 <div class="col-md-5">
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            {{--Reset Payment--}}
                                            <a id="{{ Qs::hash($uc->id) }}" onclick="confirmReset(this.id)" href="#" class="dropdown-item"><i class="icon-reset"></i> {{ __('msg.reset_payment') }}</a>
                                            ...
                                            {{--Receipt--}}
                                                <a target="_blank" href="{{ route('payments.receipts', Qs::hash($uc->id)) }}" class="dropdown-item"><i class="icon-printer"></i> {{ __('msg.print_receipt') }}</a>
                                            {{--PDF Receipt--}}
                            {{--                    <a  href="{{ route('payments.pdf_receipts', Qs::hash($uc->id)) }}" class="dropdown-item download-receipt"><i class="icon-download"></i> {{ __('msg.download_receipt') }}</a>--}}
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            ...
                                            {{--Reset Payment--}}
                                            <a id="{{ Qs::hash($cl->id) }}" onclick="confirmReset(this.id)" href="#" class="dropdown-item"><i class="icon-reset"></i> {{ __('msg.reset_payment') }}</a>
                                            ...
                                            {{--Receipt--}}
                                            <a target="_blank" href="{{ route('payments.receipts', Qs::hash($cl->id)) }}" class="dropdown-item"><i class="icon-printer"></i> {{ __('msg.print_receipt') }}</a>
